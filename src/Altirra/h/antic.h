...
public:
	...
	void	EnhancedMode67(bool enable) noexcept;	// CMC
...
private:
	...
	bool	mbEnhancedMode67 = false;	// CMC
	...
	bool	mDblXColor = false;		// CMC
	bool	mMode16Enabled = false;	// CMC
