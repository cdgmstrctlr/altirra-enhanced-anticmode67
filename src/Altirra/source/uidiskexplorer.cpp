		...
		if (c == 0x9B && mViewMode != kViewMode_HexDump) {
			...
			if (c == 0x20) {
				...
				static const uint16 kLowTable[]={
					0x2665,	// 000 heart
					0x251C,	// 001 vertical tee pointing right
					0x2595,	// 002 vertical bar right side
					0x2518,	// 003 lwr rt corner el
					0x2524,	// 004 vertical tee pointing left
					0x2510,	// 005 upper rt corner elbow
					0x2571,	// 006 forward diagonal
					0x2572,	// 007 backwards diagonal
					0x25E2,	// 008 lower right filled triangle
					0x2597,	// 009 lower right quadrant
					0x25E3,	// 010 lower left filled triangle
					0x259D, // 011 upper right quadrant
					0x2598, // 012 upper left quadrant
					...
					0x253C,	// 019 four-way
					0x2022,	// 020 filled circle
					0x2584,	// 021 bottom half (no top half - done w/ inverse char)
					0x258E,	// 022 left quarter bar
					0x252C,	// 023 horizontal tee pointing down
					0x2534,	// 024 horizontal tee pointing up
					0x258C,	// 025 left half (no rt half - done /w inverse char)
					0x2514,	// 026 top-right elbow
					0x241B,	// 027 escape
					0x2191,	// 028 up arrow
					0x2193,	// 029 down arrow
					0x2190,	// 030 left arrow
				...
				static const uint16 kHighTable[]={
					0x2660,	// 123 spade
					'|',	// 124 vertical horizontally-centered bar (leave this alone so as to not invite font issues)
					0x21B0,	// 125 curved arrow up-left (scrnclr char) (I had it at 2196 but now I think the original is better)
					0x25C4,	// 126 left wide arrow (src code pro font has better @ E0B2)
					0x25BA	// 127 right wide arrow (src code pro font has better @ E0B0)
				};
