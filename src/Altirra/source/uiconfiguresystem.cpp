...
the selection of 16 colors for both the foreground and background on a per-character basis. This also enables the \
required extended color support in GTIA. The feature is controlled via bits 3 and 4 in both CHACTL and GRACTL.");
