...
void ATInitGTIAPriorityTables(uint8 priorityTables[64][256]) {
	...
	static const uint8 mode67Priorities[9][20] =
	{
		...
		{ 0x10, 0x20, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x40, 0x80, 0x00 },	// pro 2
	...
	for (int j = 0; j < 9; j++)		// pri 1, 2, 4, & 8 TODO: everything else that isn't copied from the previously mentioned. The pri bit 4 blocks are handled by the missile renderer
	{
